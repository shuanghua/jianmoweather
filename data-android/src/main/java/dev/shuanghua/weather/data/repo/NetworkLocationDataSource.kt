...
//	}
    ...
    companion object {
        @Volatile
        private var INSTANCE: NetworkLocationDataSource? = null

        fun getInstance(client: AMapLocationClient): NetworkLocationDataSource {
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: NetworkLocationDataSource(client).also { INSTANCE = it }
            }
        }
    }
}